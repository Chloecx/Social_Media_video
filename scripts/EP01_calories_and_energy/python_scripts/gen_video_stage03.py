...
OUTPUT_PATH = os.path.join(ASSETS_DIR, "Stage3_Output.mp4")
...
# ---------------------------------------------------------
# 2. Scene 3 Shot 与素材 mapping 配置
# ---------------------------------------------------------
shots_data = [
    {
        "shot_id": "Shot3-1",
        "audio_file": "Shot3-1.mp3",
        "frames": ["Shot3-1_01"],
        "auto_align": False
    },
    {
        "shot_id": "Shot3-2",
        "audio_file": "Shot3-2.mp3",
        "frames": ["Shot3-2_01"],
        "auto_align": False
    },
    {
        "shot_id": "Shot3-3",
        "audio_file": "Shot3-3.mp3",
        "frames": ["Shot3-3_01"],
        "auto_align": False
    },
    {
        "shot_id": "Shot3-4",
        "audio_file": "Shot3-4.mp3",
        "frames": ["Shot3-4_01", "Shot3-4_02"],
        "auto_align": True,
        # 以 "exploding" 为界：前面为画面 1，从 exploding 开始为画面 2
        "target_keywords": ["exploding"]
    }
]
...
print("🎬 开始处理 Scene 3 视频合成...", flush=True)
...
if compiled_shot_clips:
    ...
    print(f"🚀 开始渲染 Scene 3 最终视频至: {OUTPUT_PATH}", flush=True)
    ...
    print("✅ Scene 3 视频制作完成！输出文件：Stage3_Output.mp4", flush=True)
