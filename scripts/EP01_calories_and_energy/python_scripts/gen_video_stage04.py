...
OUTPUT_PATH = os.path.join(ASSETS_DIR, "Stage4_Output.mp4")
...
# ---------------------------------------------------------
# 2. Scene 4 Shot 与素材 mapping 配置
# ---------------------------------------------------------
shots_data = [
    {
        "shot_id": "Shot4-1",
        "audio_file": "Shot4-1.mp3",
        "frames": ["Shot4-1_01"],
        "auto_align": False
    },
    {
        "shot_id": "Shot4-2",
        "audio_file": "Shot4-2.mp3",
        "frames": ["Shot4-2_01"],
        "auto_align": False
    },
    {
        "shot_id": "Shot4-3",
        "audio_file": "Shot4-3.mp3",
        "frames": ["Shot4-3_01"],
        "auto_align": False
    },
    {
        "shot_id": "Shot4-4",
        "audio_file": "Shot4-4.mp3",
        "frames": ["Shot4-4_01", "Shot4-4_02"],
        "auto_align": True,
        # 画面1截至 "enough" 之前，从 "enough" 开始为画面2
        "target_keywords": ["enough"]
    }
]
...
print("🎬 开始处理 Scene 4 视频合成...", flush=True)
...
if compiled_shot_clips:
    ...
    print(f"🚀 开始渲染 Scene 4 最终视频至: {OUTPUT_PATH}", flush=True)
    ...
    print("✅ Scene 4 视频制作完成！输出文件：Stage4_Output.mp4", flush=True)
